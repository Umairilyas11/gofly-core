...
class Gofly_Experience_Slider_Widget extends Widget_Base
{

    public function get_name()
    {
        return 'gofly_experience_slider';
    }

    public function get_title()
    {
        return esc_html__('EG Experience Slider', 'gofly-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'gofly_exp_slider_title',
            [
                'label'       => esc_html__('Title', 'gofly-core'),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => esc_html__('Popular Activities', 'gofly-core'),
                'placeholder' => esc_html__('Type your title here', 'gofly-core'),
                'label_block' => true,
            ]
        );
        $this->add_control(
            'gofly_exp_slider_short_desc',
            [
        ...
        $this->add_control(
            'gofly_exp_slider_post_per_page',
            [
        ...
        $this->add_control(
            'gofly_exp_slider_selected_type',
            [
                'label'       => esc_html__('Experience Type', 'gofly-core'),
                'type'        => \Elementor\Controls_Manager::SELECT2,
                'label_block' => true,
                'multiple'    => true,
                'options'     => \Egns_Core\Egns_Helper::get_post_terms_options('experience-type'),
                'description' => esc_html__('Show experience post only selected type', 'gofly-core'),
            ]
        );
        $this->add_control(
            'gofly_exp_slider_post_list',
            [
                'label'       => esc_html__('Experience lists', 'gofly-core'),
                'type'        => \Elementor\Controls_Manager::SELECT2,
                'label_block' => true,
                'multiple'    => true,
                'options'     => \Egns_Core\Egns_Helper::get_post_list_options('experience'),
                'description' => esc_html__('Selected posts appear only when linked to an experience type. By default, all selected posts are visible.', 'gofly-core'),
            ]
        );
        ...
        // Style Card
        $this->start_controls_section(
            'gofly_experience_slider_cnt_style',
            [
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_header_style',
            [
                'label'     => esc_html__('Header Area', 'gofly-core'),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'after',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_experience_slider_cnt_header_title_typ',
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_header_title_color',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_experience_slider_cnt_header_desc_typ',
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_header_desc_color',
            [
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_card_general_style',
            [
                'label'     => esc_html__('Card General', 'gofly-core'),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'after',
            ]
        );
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_card_bg_color',
            [
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_card_border_color',
            [
        ...
        $this->add_responsive_control(
            'gofly_experience_slider_cnt_card_border_radius',
            [
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_card_style',
            [
                'label'     => esc_html__('Card Content', 'gofly-core'),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'after',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Title Typography', 'gofly-core'),
                'name'     => 'gofly_experience_slider_cnt_card_title_typ',
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_card_title_color',
            [
                'label'     => esc_html__('Title Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_card_title_hover_color',
            [
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_card_info_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_experience_slider_cnt_card_location_typ',
                'selector' => '{{WRAPPER}} .package-card .package-content .location-and-time .location a',

            ]
        );
        $this->add_control(
            'gofly_experience_slider_cnt_card_location_color',
            [
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_card_location_hover_color',
            [
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'label'    => esc_html__('Time Typography', 'gofly-core'),
                'name'     => 'gofly_experience_slider_cnt_card_days_typ',
                'selector' => '{{WRAPPER}} .package-card .package-content .location-and-time span',

            ]
        );
        $this->add_control(
            'gofly_experience_slider_cnt_card_days_color',
            [
                'label'     => esc_html__('Time Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_card_info_separator_color',
            [
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_card_price_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_experience_slider_cnt_card_price_lbl_typ',
                'selector' => '{{WRAPPER}} .package-card .package-content .btn-and-price-area .price-area h6',
            ]
        );
        $this->add_control(
            'gofly_experience_slider_cnt_card_price_lbl_color',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_experience_slider_cnt_card_price_typ',
                'selector' => '{{WRAPPER}} .package-card .package-content .btn-and-price-area .price-area span',

            ]
        );
        $this->add_control(
            'gofly_experience_slider_cnt_card_price_color',
            [
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_card_price_area_separator_color',
            [
                'label'     => esc_html__('Separator Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_card_card_bottom_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_experience_slider_cnt_card_card_bottom_typ',
                'selector' => '{{WRAPPER}} .package-card .package-content .bottom-area ul li',
            ]
        );
        $this->add_control(
            'gofly_experience_slider_cnt_card_card_bottom_color',
            [
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_card_card_bottom_experience_icon_color',
            [
        ...
        $this->add_control(
            'gofly_experience_slider_cnt_card_card_bottom_tool_tip_icon_color',
            [
        ...
        // Card Image Style
        $this->start_controls_section(
            'gofly_experience_slider_cnt_card_card_image_styles',
            [
        ...
        $this->add_responsive_control(
            'gofly_experience_slider_cnt_card_card_image_radius',
            [
                'label'      => esc_html__('Border Radius', 'gofly-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
        ...
        // Card Buttons Style
        $this->start_controls_section(
            'gofly_experience_slider_card_buttons_styles',
            [
        ...
        $this->add_control(
            'gofly_experience_slider_card_main_button',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'gofly-core'),
                'name'     => 'gofly_experience_slider_card_button_typ',
                'selector' => '{{WRAPPER}} .package-card .package-content .btn-and-price-area .primary-btn1',

            ]
        );
        $this->add_control(
            'gofly_experience_slider_card_button_color',
            [
                'label'     => esc_html__('Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_experience_slider_card_button_hover_color',
            [
        ...
        $this->add_control(
            'gofly_experience_slider_card_button_icon_color',
            [
        ...
        $this->add_control(
            'gofly_experience_slider_card_button_hover_icon_color',
            [
        ...
        $this->add_control(
            'gofly_experience_slider_card_button_bg_color',
            [
                'label'     => esc_html__('Background Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_experience_slider_card_button_hover_bg_color',
            [
        ...
        $this->add_responsive_control(
            'gofly_experience_slider_card_button_radius',
            [
                'label'      => esc_html__(
                    'Border Radius',
                    'gofly-core'
        ...
        $this->add_control(
            'gofly_experience_slider_card_badge',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'gofly-core'),
                'name'     => 'gofly_experience_slider_card_badge_typ',
                'selector' => '{{WRAPPER}} .package-card .package-img-wrap .batch span',

            ]
        );
        $this->add_control(
            'gofly_experience_slider_card_badge_color',
            [
                'label'     => esc_html__('Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_experience_slider_card_badge_bg_color',
            [
                'label'     => esc_html__('Background Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'gofly_experience_slider_card_badge_radius',
            [
                'label'      => esc_html__(
                    'Border Radius',
                    'gofly-core'
    ...
    protected function render()
    {
        ...
        $type_ids          = $settings['gofly_exp_slider_selected_type'];
        $selected_post_ids = $settings['gofly_exp_slider_post_list'];

        $args = array(
            'post_type'      => 'experience',
            'order'          => $settings['gofly_exp_slider_order'],
            'orderby'        => $settings['gofly_exp_slider_orderby'],
            'posts_per_page' => $settings['gofly_exp_slider_post_per_page'],
            'post_status'    => 'publish',
            'offset'         => 0,
        );
...
?>
        ...
        <div class="home7-popular-activity-section">
            <div class="container">
                <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="col-xl-6 col-lg-8">
                        <div class="section-title text-center">
                            <h2><?php echo esc_html($settings['gofly_exp_slider_title']) ?></h2>
                            <p><?php echo esc_html($settings['gofly_exp_slider_short_desc']) ?></p>
                        </div>
                    </div>
                </div>
                <div class="row mb-40">
                                        ...
                                        <div class="package-card three">
                                            ...
                                            <div class="package-content">
                                                ...
                                                <div class="btn-and-price-area">
                                                    <a href="experience-details.html" class="primary-btn1 four">
                                                        <span>
                                                ...
                                                <?php if (!empty(Egns_Helper::egns_get_exp_value('experience_tooltip_content_label') || Egns_Helper::egns_get_exp_value('inclusion_tooltip_content_label'))) : ?>
                                                    ...
                                                    <div class="bottom-area">
                                                        <ul>
                                                            <?php if (!empty(Egns_Helper::egns_get_exp_value('experience_tooltip_content_label'))) : ?>
                                                                <li>
                                                                    ...
                                                                    <?php echo Egns_Helper::egns_get_exp_value('experience_tooltip_content_label') ?>
                                                                    <div class="info">
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if (!empty(Egns_Helper::egns_get_exp_value('inclusion_tooltip_content_label'))) : ?>
                                                                <li>
                                                                    <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                                                        <g>
                                                                            <path
                                                                    ...
                                                                    <?php echo Egns_Helper::egns_get_exp_value('inclusion_tooltip_content_label') ?>
                                                                    <div class="info">
                                                                        <svg width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                                                            <g>
                                                                                <path
                ...
                <div class="row">
                    <div class="col-lg-12 d-flex justify-content-center">
                        <div class="swiper-pagination2 paginations three"></div>
                    </div>
                </div>
            </div>
        </div>
...
Plugin::instance()->widgets_manager->register(new Gofly_Experience_Slider_Widget());
