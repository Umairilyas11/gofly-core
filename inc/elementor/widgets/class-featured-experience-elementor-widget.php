...
class Gofly_Exp_Featured_Image_Widget extends Widget_Base
{

    public function get_name()
    {
        return 'gofly_exp_featured';
    }

    public function get_title()
    {
        return esc_html__('EG Experience Featured', 'gofly-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'content'     => esc_html__('This Widgets only for custom post "Experience" details page.', 'gofly-core'),
            ]
        );
        ...
        $this->start_controls_section(
            'gofly_experience_featured_style_section',
            [
        ...
        $this->add_control(
            'gofly_experience_single_hero_title_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_experience_single_hero_title_typ',
        ...
        $this->add_control(
            'gofly_experience_single_hero_title_color',
            [
        ...
        $this->add_control(
            'gofly_experience_single_hero_price_text_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'gofly-core'),
                'name'     => 'gofly_experience_single_hero_price_text_typ',
        ...
        $this->add_control(
            'gofly_experience_single_hero_price_text_color',
            [
                'label'     => esc_html__('Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_experience_single_hero_price_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'gofly-core'),
                'name'     => 'gofly_experience_single_hero_price_typ',
        ...
        $this->add_control(
            'gofly_experience_single_hero_price_color',
            [
                'label'     => esc_html__('Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_experience_single_hero_duration_nd_location_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'gofly-core'),
                'name'     => 'gofly_experience_single_hero_duration_nd_location_typ',
        ...
        $this->add_control(
            'gofly_experience_single_hero_duration_nd_location_color',
            [
                'label'     => esc_html__('Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_experience_single_hero_duration_nd_location_bg_color',
            [
        ...
        $this->add_control(
            'gofly_experience_single_hero_duration_nd_location_border_color',
            [
        ...
        $this->add_responsive_control(
            'gofly_experience_single_hero_duration_nd_location_border_radius',
            [
                'label'      => esc_html__(
                    'Border Radius',
                    'gofly-core'
        ...
        $this->add_control(
            'gofly_experience_single_hero_slider_button_style',
            [
        ...
        $this->add_control(
            'gofly_experience_single_hero_slider_button_icon_color',
            [
        ...
        $this->add_control(
            'gofly_experience_single_hero_slider_button_icon_hover_color',
            [
        ...
        $this->add_control(
            'gofly_experience_single_hero_slider_button_bg_color',
            [
                'label'     => esc_html__('Background Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_experience_single_hero_slider_button_bg_hover_color',
            [
        ...
        $this->add_control(
            'gofly_experience_single_hero_slider_button_border_color',
            [
                'label'     => esc_html__('Border Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_experience_single_hero_slider_button_border_hover_color',
            [
        ...
        $this->add_responsive_control(
            'gofly_experience_single_hero_slider_button_border_radius',
            [
                'label'      => esc_html__(
                    'Border Radius',
                    'gofly-core'
    ...
    protected function render()
    {
        ...
        $tour_feature_video_uplaod = Egns_Helper::egns_get_exp_value('experience_featured_video_uplaod', 'url');
        $tour_feature_video_link   = Egns_Helper::egns_get_exp_value('experience_featured_video_link');
            ...
            <div class="banner-content-wrap">
                <div class="container">
                    <div class="banner-content">
                        <?php echo Egns_Helper::exp_single_starting_price($id)
                        ?>
                        <h1><?php echo esc_html(get_the_title($id)) ?></h1>
                        <div class="batch">
                            <span>
                                <?php
                                if (!empty(Egns_Helper::egns_get_exp_value('experience_duration_hour'))) {
                                    echo Egns_Helper::egns_get_exp_value('experience_duration_hour');
                                }
                                ?>
                                <?php
                                if (!empty(Egns_Helper::egns_get_exp_value('experience_destination_select'))) {

                                    $locations = [];
                                    foreach (Egns_Helper::egns_get_exp_value('experience_destination_select') as $location_id) {
                                        $locations[] = esc_html(get_the_title($location_id));
                                    }
...
Plugin::instance()->widgets_manager->register(new Gofly_Exp_Featured_Image_Widget());
