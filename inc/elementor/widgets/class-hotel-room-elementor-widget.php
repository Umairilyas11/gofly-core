...
class Gofly_Hotel_Room_Widget extends Widget_Base
{

    public function get_name()
    {
        return 'gofly_hotel_room';
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'gofly_hotel_room_genaral',
            [
                'label' => esc_html__('General', 'gofly-core')
            ]
        );
        $this->add_control(
            'gofly_hotel_room_general_title',
            [
        ...
        $this->add_control(
            'gofly_hotel_room_general_title_style',
            [
                'label'     => esc_html__('Title', 'gofly-core'),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'after',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_hotel_room_general_title_typ',
                'selector' => '{{WRAPPER}} .section-title h2',
            ]
        );
        $this->add_control(
            'gofly_hotel_room_general_title_color',
            [
        ...
        $this->add_control(
            'gofly_hotel_room_general_desc_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'gofly-core'),
                'name'     => 'gofly_hotel_room_general_desc_typ',
                'selector' => '{{WRAPPER}} .section-title p',
            ]
        );
        $this->add_control(
            'gofly_hotel_room_general_desc_color',
            [
                'label'     => esc_html__('Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_hotel_room_card_bg_color',
            [
        ...
        $this->add_control(
            'gofly_hotel_room_card_border_color',
            [
        ...
        $this->add_responsive_control(
            'gofly_hotel_room_card_border_radius',
            [
                'label'      => esc_html__(
                    'Border Radius',
                    'gofly-core'
        ...
        $this->add_control(
            'gofly_hotel_room_card_title_style',
            [
                'label'     => esc_html__('Title', 'gofly-core'),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'after',
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'gofly-core'),
                'name'     => 'gofly_hotel_room_card_title_typ',
                'selector' => '{{WRAPPER}} .hotel-card .hotel-content h5 a',
            ]
        );
        $this->add_control(
            'gofly_hotel_room_card_title_color',
            [
                'label'     => esc_html__('Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_hotel_room_card_title_hover_color',
            [
        ...
        $this->add_control(
            'gofly_hotel_room_location_hover_color',
            [
        ...
        $this->add_control(
            'gofly_hotel_room_map_icon_color',
            [
        ...
        $this->add_control(
            'gofly_hotel_room_info_map_button_color',
            [
        ...
        $this->add_control(
            'gofly_hotel_room_info_map_button_hover_color',
            [
        ...
        $this->add_control(
            'gofly_hotel_room_info_map_button_icon_color',
            [
        ...
        $this->add_control(
            'gofly_hotel_room_info_map_button_hover_icon_color',
            [
        ...
        $this->add_control(
            'gofly_hotel_room_facilities_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'gofly-core'),
                'name'     => 'gofly_hotel_room_facility_typ',
                'selector' => '{{WRAPPER}} .hotel-card .hotel-content .hotel-feature-list li',
            ]
        );
        $this->add_control(
            'gofly_hotel_room_facility_color',
            [
                'label'     => esc_html__('Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_hotel_room_facility_icon_color',
            [
                'label'     => esc_html__('Icon Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_hotel_room_facility_icon_border_color',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'gofly-core'),
                'name'     => 'gofly_hotel_room_cancellation_typ',
                'selector' => '{{WRAPPER}} .hotel-card .hotel-content .cancellation span',
            ]
        );

        $this->add_control(
            'gofly_hotel_room_cancel_color',
            [
                'label'     => esc_html__('Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_hotel_room_cancel_icon_color',
            [
                'label'     => esc_html__('Icon Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_hotel_room_cancel_icon_bg_color',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Text Typography', 'gofly-core'),
                'name'     => 'gofly_hotel_room_review_text_typ',
                'selector' => '{{WRAPPER}} .hotel-card .hotel-content .rating-area span',
            ]
        );
        $this->add_control(
            'gofly_hotel_room_review_text_color',
            [
                'label'     => esc_html__('Text Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_hotel_room_review_star_color',
            [
        ...
        // Card Image Style
        $this->start_controls_section(
            'gofly_hotel_room_card_image_styles',
            [
        ...
        $this->add_control(
            'gofly_hotel_room_card_image_style',
            [
        ...
        $this->add_responsive_control(
            'gofly_hotel_room_card_image_radius',
            [
                'label'      => esc_html__(
                    'Border Radius',
                    'gofly-core'
        ...
        // Card Buttons Style
        $this->start_controls_section(
            'gofly_hotel_room_card_buttons_styles',
            [
        ...
        $this->add_control(
            'gofly_hotel_room_card_main_button',
            [
        ...
        $this->add_control(
            'gofly_hotel_room_card_button_hover_color',
            [
                'label'     => esc_html__('Hover Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_hotel_room_card_button_icon_color',
            [
                'label'     => esc_html__('Icon Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_hotel_room_card_button_hover_icon_color',
            [
        ...
        $this->add_control(
            'gofly_hotel_room_card_button_bg_color',
            [
                'label'     => esc_html__('Background Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_hotel_room_card_button_hover_bg_color',
            [
        ...
        $this->add_responsive_control(
            'gofly_hotel_room_card_button_radius',
            [
                'label'      => esc_html__(
                    'Border Radius',
                    'gofly-core'
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'gofly-core'),
                'name'     => 'gofly_hotel_room_card_badge_typ',
                'selector' => '{{WRAPPER}} .hotel-card .hotel-img-wrap .batch span',
            ]
        );

        $this->add_control(
            'gofly_hotel_room_card_badge_color',
            [
                'label'     => esc_html__('Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'gofly_hotel_room_card_badge_bg_color',
            [
                'label'     => esc_html__('Background Color', 'gofly-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'gofly_hotel_room_card_badge_radius',
            [
                'label'      => esc_html__(
                    'Border Radius',
                    'gofly-core'
...
?>
        ...
        <div class="home1-travel-package-section">
            <div class="container">
                <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="col-xl-6 col-lg-8">
                        <div class="section-title text-center">
                            <?php if (! empty($settings['gofly_hotel_room_general_title'])): ?>
                                <h2><?php echo esc_html($settings['gofly_hotel_room_general_title']); ?></h2>
                            <?php endif; ?>
                            <?php if (! empty($settings['gofly_hotel_room_general_desc'])): ?>
                                <p><?php echo esc_html($settings['gofly_hotel_room_general_desc']); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                <div class="row gy-lg-5 gy-4">
                    ...
                    ?>
                        <div class="col-md-6 col-lg-4 item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
...
Plugin::instance()->widgets_manager->register(new Gofly_Hotel_Room_Widget());
