...
class Gofly_Tour_Check_Availability_Image_Widget extends Widget_Base
{

    public function get_name()
    {
        return 'gofly_tour_check_availability';
    }

    public function get_title()
    {
        return esc_html__('EG Tour Check Availability', 'gofly-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'gofly_tour_check_availability_content_section',
            [
        ...
        $this->add_control(
            'tour_check_availability_heading',
            [
                ...
                'label_block' => true,
                'condition'   => [
                    'tour_check_or_form_enable!' => 'form',
                ],
            ]
        );
        $this->add_control(
            'tour_check_availability_desc',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'condition'   => [
                    'tour_check_or_form_enable!' => 'check',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'tour_booking_priority_list',
            [
                'label'  => esc_html__('Priority list', 'gofly-core'),
                'type'   => \Elementor\Controls_Manager::REPEATER,
                'fields' => [
                    [
                        'name'        => 'tour_priority_item',
                ...
                'default' => [
                    [
                        'tour_priority_item' => esc_html__('Mony Back Guarentee.', 'gofly-core'),
                    ],
                    [
                        'tour_priority_item' => esc_html__('Your Safety is Our Top Priority.', 'gofly-core'),
                    ],
                ],
                'title_field' => '{{{ tour_priority_item }}}',
            ]
        );
        ...
        $this->start_controls_section(
            'gofly_tour_check_availability_style_section',
            [
        ...
        $this->add_control(
            'gofly_tour_check_availability_area_style',
            [
        ...
        $this->add_control(
            'gofly_tour_check_availability_area_bg_color',
            [
        ...
        $this->add_responsive_control(
            'gofly_tour_check_availability_area_border_radius',
            [
                'label'      => esc_html__(
                    'Card Border Radius',
                    'gofly-core'
        ...
        $this->add_control(
            'gofly_tour_check_availability_area_discout_badge_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_tour_check_availability_area_discount_typ',
        ...
        $this->add_control(
            'gofly_tour_check_availability_area_discount_color',
            [
        ...
        $this->add_control(
            'gofly_tour_check_availability_area_discount_bg_color',
            [
        ...
        $this->add_responsive_control(
            'gofly_tour_check_availability_area_discount_border_radius',
            [
                'label'      => esc_html__(
                    'Border Radius',
                    'gofly-core'
        ...
        $this->add_control(
            'gofly_tour_check_availability_area_price_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_tour_check_availability_area_title_typ',
        ...
        $this->add_control(
            'gofly_tour_check_availability_area_title_color',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_tour_check_availability_price_typ',
        ...
        $this->add_control(
            'gofly_tour_check_availability_price_color',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_tour_check_availability_price_info_typ',
        ...
        $this->add_control(
            'gofly_tour_check_availability_price_info_color',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_tour_check_availability_price_features_typ',
        ...
        $this->add_control(
            'gofly_tour_check_availability_price_features_color',
            [
        ...
        $this->add_control(
            'gofly_tour_check_availability_price_info_icon_color',
            [
        ...
        $this->add_control(
            'gofly_tour_check_availability_apply_button_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_tour_check_availability_button_typ',
        ...
        $this->add_control(
            'gofly_tour_check_availability_button_color',
            [
        ...
        $this->add_control(
            'gofly_tour_check_availability_button_hover_color',
            [
        ...
        $this->add_control(
            'gofly_tour_check_availability_button_icon_color',
            [
        ...
        $this->add_control(
            'gofly_tour_check_availability_button_icon_hover_color',
            [
        ...
        $this->add_control(
            'gofly_tour_check_availability_button_bg_color',
            [
        ...
        $this->add_control(
            'gofly_tour_check_availability_button_hover_bg_color',
            [
        ...
        $this->add_responsive_control(
            'gofly_tour_check_availability_button_border_radius',
            [
                'label'      => esc_html__(
                    'Border Radius',
                    'gofly-core'
        ...
        $this->add_control(
            'gofly_tour_enquiry_button_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_tour_enquiry_button_typ',
        ...
        $this->add_control(
            'gofly_tour_enquiry_button_color',
            [
        ...
        $this->add_control(
            'gofly_tour_enquiry_button_hover_color',
            [
        ...
        $this->add_control(
            'gofly_tour_enquiry_button_icon_color',
            [
        ...
        $this->add_control(
            'gofly_tour_enquiry_button_icon_hover_color',
            [
        ...
        $this->add_control(
            'gofly_tour_enquiry_button_bg_color',
            [
        ...
        $this->add_control(
            'gofly_tour_enquiry_button_hover_bg_color',
            [
        ...
        $this->add_control(
            'gofly_tour_enquiry_button_hover_border_color',
            [
        ...
        $this->add_responsive_control(
            'gofly_tour_enquiry_button_border_radius',
            [
                'label'      => esc_html__(
                    'Border Radius',
                    'gofly-core'
        ...
        $this->add_control(
            'gofly_tour_enquiry_offer_info_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'gofly_tour_enquiry_offer_notice_typ',
        ...
        $this->add_control(
            'gofly_tour_enquiry_offer_notice_color',
            [
        ...
        $this->add_control(
            'gofly_tour_enquiry_offer_notice_icon_color',
            [
    ...
    protected function render()
    {
        ...
        $id            = get_the_ID();
        $service_terms = get_the_terms($id, 'tour-service');
        $tour_package  = Egns_Helper::egns_get_tour_value('tour_pricing_package');

        // Localize script for AJAX
        wp_localize_script('gofly-core-script', 'gofly_core_ajax', [
...
?>
        ...
        <div class="package-details-sidebar">
            <div class="pricing-and-booking-area">
                <?php if (Egns_Helper::has_sale_price($id)): ?>
                    <div class="batch">
                        <span><?php echo Egns_Helper::get_global_discount_percentage($id) . esc_html__('% Off', 'gofly-core') ?></span>
                    </div>
                <?php endif; ?>
                <?php echo Egns_Helper::get_single_starting_price($id, 'two') ?>
                <?php if (!empty($settings['tour_booking_priority_list'])): ?>
                    <ul>
                        <?php foreach ($settings['tour_booking_priority_list'] as $item): ?>
                            <li>
                                ...
                                <?php echo esc_html($item['tour_priority_item']) ?>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                <?php endif; ?>
                <?php if ($settings['tour_check_or_form_enable'] != 'form' && !empty($tour_package)): ?>
                    <button class="primary-btn1 mb-20" data-bs-toggle="modal" data-bs-target="#booking<?php echo esc_attr($id) ?>">
                        <span>
                            <?php echo esc_html($settings['tour_check_availability_btn']) ?>
                ...
                <span>
                    ...
                    <?php echo esc_html($settings['tour_bonus_lbl']) ?>
                </span>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4><?php echo esc_html($settings['tour_check_availability_heading']) ?></h4>
                        <p><?php echo esc_html($settings['tour_check_availability_desc']) ?></p>
                    </div>
                    <div class="modal-body">
                            ...
                            <div class="row g-4 mb-50">
                                <div class="col-sm-6">
                                    <div class="single-field date-field">
                                        ...
                                        <div class="custom-select-dropdown tour-order">
                                            <input type="text" name="inOut" value="Sep 12 - Sep 20">
                                            ...
                                            <h6 id="guest-summary">
                                                ...
                                                if (!empty($terms) && !is_wp_error($terms)) {
                                                    ...
                                                    foreach ($terms as $term) {
                                                        // default quantities
                                                        $default_qty =  1;
                                                        $output[] = '<span id="qnt-' . esc_attr($term->slug) . '" data-type="' . esc_attr($term->slug) . '">' . $default_qty . '</span> ' . esc_html($term->name);
                                                    }
                                                    echo implode(', ', $output);
                                                }
                                                ?>
                                            </h6>
                                            <span><?php echo esc_html__('Select Travelers', 'gofly-core') ?></span>
                                        </div>

                                        <div class="custom-select-wrap">
                                            <div class="title-area">
                                                <h6><?php echo esc_html__('Travelers', 'gofly-core') ?></h6>
                                                <span><?php echo esc_html__('You can book for a maximum number of people', 'gofly-core') . sprintf(' %02d', Egns_Helper::egns_get_tour_value('tour_traveler_max')) ?></span>
                                            </div>
                                            <?php
                                            $taxonomy = 'tour-pricing-category';
                                            $terms = get_terms([
                                            ...
                                            ?>
                                                <ul class="guest-count">
                                                    <?php foreach ($terms as $key => $term) :
                                                        $min_age = get_term_meta($term->term_id, 'tour_price_cat_min_age', true);
                                                        $max_age = get_term_meta($term->term_id, 'tour_price_cat_max_age', true);
                                                        // Label with age range
                                                        $age_label = '';
                                                        if ($min_age !== '' && $max_age !== '') {
                                                            $age_label = $min_age . ' - ' . $max_age . ' years';
                                                        } elseif ($min_age !== '') {
                                                            $age_label = $min_age . '+ years';
                                                        } elseif ($max_age !== '') {
                                                            $age_label = '0 - ' . $max_age . ' years';
                                                        }
                                                    ?>
                                                        <li class="single-item">
                                                            ...
                                                            <div class="quantity-counter">
                                                                <a href="#" data-type="<?php echo esc_attr($term->slug); ?>" class="guest-quantity__minus"><i class="bi bi-dash"></i></a>
                                                                <input name="<?php echo esc_attr($term->slug); ?>_quantity" type="number" class="quantity__input" value="1" data-type="<?php echo esc_attr($term->slug); ?>">
                                                                <a href="#" data-type="<?php echo esc_attr($term->slug); ?>" class="guest-quantity__plus"><i class="bi bi-plus"></i></a>
                                                            </div>
                                                        </li>
                                                    <?php endforeach; ?>
                                                </ul>
                        ...
                        <?php if (!empty($tour_package)): ?>
                            <div class="package-list">
                                <div class="accordion accordion-flush" id="accordionFlushPackage">
                                    <?php foreach ($tour_package as $key => $package): ?>
                                        <div class="accordion-item tour-accordion-item">
                                            <div class="accordion-header" id="flush-package-heading<?php echo esc_attr($key) ?>">
                                                <div class="accordion-button<?php echo $key == 0 ? '' : ' collapsed' ?>" role="button" data-bs-toggle="collapse" data-bs-target="#flush-package-collapse<?php echo esc_attr($key) ?>" aria-expanded="false" aria-controls="flush-package-collapse<?php echo esc_attr($key) ?>">
                                                    <div class="batch">
                                                        <span><?php echo esc_html($package['tour_pricing_package_type']) ?></span>
                                                    </div>
                                                    <div class="title-area">
                                                        <span class="check"></span>
                                                        <h6><?php echo esc_html($package['tour_pricing_package_title']) ?></h6>
                                                    </div>
                                                    ...
                                                    if (!empty($regular_prices)) {
                                                        ...
                                                        foreach ($regular_prices as $taxonomy => $reg_values) {
                                                            if (!is_array($reg_values)) continue;

                                                            foreach ($reg_values as $index => $reg_price) {
                                                                $reg_price  = ($reg_price !== "" && $reg_price !== null) ? floatval($reg_price) : 0;

                                                                $sale_price = isset($sale_prices[$taxonomy][$index]) && $sale_prices[$taxonomy][$index] !== "" ? floatval($sale_prices[$taxonomy][$index]) : null;

                                                                // Use sale price if exists & smaller
                                                                $effective_price = ($sale_price !== null && $sale_price < $reg_price) ? $sale_price : $reg_price;

                                                                $total += $effective_price;
                                                            }
                                                        }

                                                        echo '<span class="total">' . Egns_Helper::gofly_format_price($total) . '</span>';
                                                    }
                                                    ?>
                                            ...
                                            <div id="flush-package-collapse<?php echo esc_attr($key) ?>" class="accordion-collapse collapse<?php echo $key == 0 ? ' show' : '' ?>" aria-labelledby="flush-package-heading<?php echo esc_attr($key) ?>" data-bs-parent="#accordionFlushPackage">
                                                <div class="accordion-body">
                                                    <div class="tour-info-and-calculate-area">
                                                        <div class="dsc">
                                                            <?php echo wp_kses_post($package['tour_pricing_package_desc']) ?>
                                                        </div>
                                                        <?php
                                                        $regular_prices = $package['trip_price_table']['regular_price'] ?? [];
                                                        $sale_prices    = $package['trip_price_table']['sale_price'] ?? [];
                                                        if (!empty($regular_prices)) {
                                                            echo '<div class="price-calculate">';
                                                            foreach ($regular_prices as $taxonomy => $reg_value) {
                                                                ...
                                                                if ($regular !== null) {
                                                                    $effective = ($sale !== null && $sale < $regular) ? $sale : $regular;
                                                                    echo '<span class="price-line" data-type="' . esc_attr($taxonomy) . '" data-price="' . esc_attr($effective) . '">';
                                                                    if ($sale !== null && $sale < $regular) {
                                                                        echo '<del>' . Egns_Helper::gofly_format_price($regular) . '</del> ' . Egns_Helper::gofly_format_price($sale);
                                                                    } else {
                                                                        echo Egns_Helper::gofly_format_price($regular);
                                                                    }
                                                                    echo ' <i class="bi bi-x"></i> <b class="line-qty" data-type="' . esc_attr($taxonomy) . '">01</b> ' . ucfirst($taxonomy);
                                                                    echo '</span>';
                                                                }
                                                            }
                                                            echo '</div>';
                                                        ...
                                                        <div class="additional-service-area">
                                                            ...
                                                            <ul class="service-list">
                                                                ...
                                                                foreach ($service_terms as $term) {
                                                                    $price_sr     = get_term_meta($term->term_id, 'egns_tour_service', true);
                                                                    $price_suffix = $price_sr['tour_service_suffix_price'];
                                                                    $suffix       = '';
                                                                    if ($price_suffix == 'perhour') {
                                                                        $suffix = '<sub>/' . esc_html__('Per Hour', 'gofly-core') . '</sub>';
                                                                    } elseif ($price_suffix == 'perperson') {
                                                                        $suffix = '<sub>/' . esc_html__('Per person', 'gofly-core') . '</sub>';
                                                                    } else {
                                                                        $suffix = '<sub>/' . esc_html__('Per Package', 'gofly-core') . '</sub>';
                                                                    }
                                                                ?>
                                                                    <li class="service" data-id="<?php echo esc_attr($term->slug); ?>" data-price="<?php echo esc_attr($price_sr['tour_service_price']); ?>">
                                                                        ...
                                                                        <div class="pricing-and-count-area disabled">
                                                                            <span><?php echo Egns_Helper::gofly_format_price($price_sr['tour_service_price']) . wp_kses_post($suffix) ?></span>
                                                                            <div class="quantity-counter">
                                                    ...
                                                    <div class="btn-area">
                                                        <a href="#" class="primary-btn1 two add-to-cart-btn">
                                                            <span>
                                                                <?php echo esc_html('Book Now', 'gofly-core') ?>
        ...
        <div class="modal enquiry-modal fade" id="enquiry<?php echo esc_attr($id) ?>" tabindex="-1" aria-labelledby="enquiryModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <button type="button" class="close-btn" data-bs-dismiss="modal" aria-label="Close">
...
Plugin::instance()->widgets_manager->register(new Gofly_Tour_Check_Availability_Image_Widget());
