...
class Gofly_Travel_Package_Slider_Widget extends Widget_Base
{

    public function get_name()
    {
        return 'gofly_travel_package_slider';
    }

    public function get_title()
    {
        return esc_html__('EG Travel Package Slider', 'gofly-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'gofly_travel_package_slider_genaral_selection',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __('One Day Trips', 'gofly-core'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'gofly_travel_package_slider_genaral_order',
            [
        ...
        $this->add_control(
            'gofly_travel_package_slider_genaral_orderby',
            [
        ...
        $this->add_control(
            'gofly_travel_package_slider_genaral_post_per_page',
            [
        ...
        $this->add_control(
            'gofly_travel_package_slider_genaral_tour_type',
            [
        ...
        $this->add_control(
            'gofly_travel_package_slider_genaral_tour_list',
            [
        ...
        $this->add_control(
            'gofly_travel_package_slider_genaral_two_vector_image_one',
            [
                'label'       => esc_html__('Vector Image One', 'gofly-core'),
                'type'        => \Elementor\Controls_Manager::MEDIA,
                'media_types' => ['image', 'svg'],
                'condition'   => [
                    'gofly_travel_package_slider_genaral_selection' => ['style_two'],
                ]
            ]
        );

        $this->add_control(
            'gofly_travel_package_slider_genaral_two_vector_image_two',
            [
        ...
        $this->add_control(
            'gofly_travel_package_slider_genaral_two_vector_image_three',
            [
                'label'       => esc_html__('Vector Image Three', 'gofly-core'),
                'type'        => \Elementor\Controls_Manager::MEDIA,
                'media_types' => ['image', 'svg'],
                'condition'   => [
                    'gofly_travel_package_slider_genaral_selection' => ['style_two'],
    ...
    protected function render()
    {
        ...
        $type_ids          = $settings['gofly_travel_package_slider_genaral_tour_type'];
        $selected_post_ids = $settings['gofly_travel_package_slider_genaral_tour_list'];

        $args = array(
            'post_type'      => 'tour',
            'order'          => $settings['gofly_travel_package_slider_genaral_order'],
            'orderby'        => $settings['gofly_travel_package_slider_genaral_orderby'],
            'posts_per_page' => $settings['gofly_travel_package_slider_genaral_post_per_page'],
            'post_status'    => 'publish',
            'offset'         => 0,
        );
...
<?php if ($settings['gofly_travel_package_slider_genaral_selection'] == 'style_one'): ?>
                            ...
                            <div class="package-card">
                                <div class="package-img-wrap">
                                    ...
                                    <div class="batch">
                                        ...
                                        <span
                                            class="discount"><?php echo esc_html__('Featured',  'gofly-core') ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="package-content">
                                    ...
                                    <div class="btn-and-price-area">
                                        <div class="btn-area">
                                            <button class="primary-btn1 eg-pbar-quote-btn" data-bs-toggle="modal"
                                    ...
                                    <div class="modal enquiry-modal fade" id="enquiry<?php echo get_the_ID(); ?>"
...
<?php if ($settings['gofly_travel_package_slider_genaral_selection'] == 'style_two'): ?>
<div class="home2-package-slider-section">
    <div class="container">
        ...
        <div class="row mb-40">
                                ...
                                <div class="package-content">
                                    ...
                                    <div class="btn-and-price-area">
                                        <div class="btn-area">
                                            ...
                                            <div class="modal enquiry-modal fade"
                                                id="enquiry<?php echo get_the_ID(); ?>" tabindex="-1"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <button type="button" class="close-btn" data-bs-dismiss="modal"
            ...
            <?php if (!empty($settings['gofly_travel_package_slider_genaral_two_vector_image_one']['url'])): ?>
            <img src="<?php echo esc_url($settings['gofly_travel_package_slider_genaral_two_vector_image_one']['url']); ?>"
                alt="<?php echo esc_attr__('vector-image', 'gofly-core'); ?>" class="vector1">
            <?php endif; ?>
            <?php if (!empty($settings['gofly_travel_package_slider_genaral_two_vector_image_two']['url'])): ?>
            <img src="<?php echo esc_url($settings['gofly_travel_package_slider_genaral_two_vector_image_two']['url']); ?>"
                alt="<?php echo esc_attr__('vector-image', 'gofly-core'); ?>" class="vector2">
            <?php endif; ?>
            <?php if (!empty($settings['gofly_travel_package_slider_genaral_two_vector_image_three']['url'])): ?>
            <img src="<?php echo esc_url($settings['gofly_travel_package_slider_genaral_two_vector_image_three']['url']); ?>"
                alt="<?php echo esc_attr__('vector-image', 'gofly-core'); ?>" class="vector3">
            <?php endif; ?>
        </div>
        <?php endif; ?>
...
Plugin::instance()->widgets_manager->register(new Gofly_Travel_Package_Slider_Widget());