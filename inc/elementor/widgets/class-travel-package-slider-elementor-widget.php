        ...
        <?php if ($settings['gofly_travel_package_slider_genaral_selection'] == 'style_two'): ?>
            <div class="home2-package-slider-section">
                ...
                <?php if (!empty($settings['gofly_travel_package_slider_genaral_two_vector_image_one']['url'])): ?>
                    <img src="<?php echo esc_url($settings['gofly_travel_package_slider_genaral_two_vector_image_one']['url']); ?>" alt="<?php echo esc_attr__('vector-image', 'gofly-core'); ?>" class="vector1">
                <?php endif; ?>
                <?php if (!empty($settings['gofly_travel_package_slider_genaral_two_vector_image_two']['url'])): ?>
                    <img src="<?php echo esc_url($settings['gofly_travel_package_slider_genaral_two_vector_image_two']['url']); ?>" alt="<?php echo esc_attr__('vector-image', 'gofly-core'); ?>" class="vector2">
                <?php endif; ?>
                <?php if (!empty($settings['gofly_travel_package_slider_genaral_two_vector_image_three']['url'])): ?>
                    <img src="<?php echo esc_url($settings['gofly_travel_package_slider_genaral_two_vector_image_three']['url']); ?>" alt="<?php echo esc_attr__('vector-image', 'gofly-core'); ?>" class="vector3">
                <?php endif; ?>
            </div>
        <?php endif; ?>
