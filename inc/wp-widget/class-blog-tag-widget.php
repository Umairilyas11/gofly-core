...
class Egns_Blog_Tags_Custom_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            __('Egns Blog Tags (Custom)', 'gofly-core'),
            array(
                'description' => __('Displays blog tags in custom HTML structure', 'gofly-core'),
            )
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        if (!empty($tags)) {
            ...
            echo '<p>' . esc_html__('No tags found.', 'gofly-core') . '</p>';
        }
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number_of_tags')); ?>"><?php echo esc_html__('Number of tags to show:', 'gofly-core'); ?></label>
