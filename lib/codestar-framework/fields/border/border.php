  ...
  class CSF_Field_border extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'top_placeholder'    => esc_html__( 'top', 'gofly-core' ),
        'right_placeholder'  => esc_html__( 'right', 'gofly-core' ),
        'bottom_placeholder' => esc_html__( 'bottom', 'gofly-core' ),
        'left_placeholder'   => esc_html__( 'left', 'gofly-core' ),
        'all_placeholder'    => esc_html__( 'all', 'gofly-core' ),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__( 'Solid', 'gofly-core' ),
        'dashed'    => esc_html__( 'Dashed', 'gofly-core' ),
        'dotted'    => esc_html__( 'Dotted', 'gofly-core' ),
        'double'    => esc_html__( 'Double', 'gofly-core' ),
        'inset'     => esc_html__( 'Inset', 'gofly-core' ),
        'outset'    => esc_html__( 'Outset', 'gofly-core' ),
        'groove'    => esc_html__( 'Groove', 'gofly-core' ),
        'ridge'     => esc_html__( 'ridge', 'gofly-core' ),
