...
if ( ! class_exists( 'CSF_Field_link_color' ) ) {
  class CSF_Field_link_color extends CSF_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'gofly-core' ),
        'hover'    => esc_html__( 'Hover', 'gofly-core' ),
        'active'   => esc_html__( 'Active', 'gofly-core' ),
        'visited'  => esc_html__( 'Visited', 'gofly-core' ),
        'focus'    => esc_html__( 'Focus', 'gofly-core' )
      );
